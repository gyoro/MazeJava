 ...
 * IDEAS TO IMPROVE
**************************************
- Fix scrolling issue of non-refreshing applet.

- Maybe add a few monsters to the maze that you must avoid.

- Add a timer.

- Make focus listener into a single class

- Make pixel perfect:  bread-crumbs and player circle
